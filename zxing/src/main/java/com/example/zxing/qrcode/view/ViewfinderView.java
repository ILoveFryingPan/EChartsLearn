...
package com.example.zxing.qrcode.view;
...
public final class ViewfinderView extends View {
    ...
    private int labelTextTopMargin;
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        labelTextSize = array.getDimension(R.styleable.ViewfinderView_label_text_size, 36);
        labelTextTopMargin = (int) array.getDimensionPixelSize(R.styleable.ViewfinderView_label_text_top_margin, 40);
...
//        canvas.drawText(labelText, frame.left + frame.width() / 2, frame.bottom + CORNER_RECT_HEIGHT * 1.5f, paint);
        canvas.drawText(labelText, frame.left + frame.width() / 2, frame.bottom + labelTextTopMargin, paint);
    }
